    ...
    <BaseLayout>
      <section className="my-16 bg-gradient-to-b from-white to-white via-yellow-100">
        ...
        <div className='text-center space-y-8'>
          <h className='bg-yellow-400 px-12 py-4 rounded-2xl text-lg font-medium'>সম্পাদকীয়</h>
          <h1 className='font-bold text-4xl py-4'>শীৰ্ষ সম্পাদকীয়</h1>
        </div>
        ...
        <div className="flex justify-evenly flex-wrap">
          {allEditorials
            ...
            .map((post) => (
              <Link
          href={`/editorial/${post.slug}`} key={post.slug}
